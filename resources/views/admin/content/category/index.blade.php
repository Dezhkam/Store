                    ...
                    <tbody>
                        @foreach ($postCategories as $postCategory)
                            <tr>
                                ...
                                <td>
                                    <label>
                                        <input data-url="{{ route('admin.content.category.status',$postCategory->id) }}" id="{{  $postCategory->id }}" onchange="changeStatus({{ $postCategory->id }})" type="checkbox" @if ($postCategory->status===1)  checked  @endif >
                                    </label>
                                </td>
